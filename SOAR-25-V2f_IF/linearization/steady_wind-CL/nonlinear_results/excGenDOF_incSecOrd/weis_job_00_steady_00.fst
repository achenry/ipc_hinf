...
---------------------- INPUT FILES ---------------------------------------------
"weis_job_00_steady_00_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"weis_job_00_steady_00_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"weis_job_00_steady_00_AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"weis_job_00_steady_00_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"none"                 HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"SOAR_V2e_s_SubDyn_monopile.dat" SubFile     - Name of file containing sub-structural input parameters (quoted string)
